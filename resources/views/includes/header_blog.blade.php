            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
                    <div class="header-top-info">
                        <a href="tel:+23-345-67890">Gọi cho chúng tôi : <span>+23-345-67890</span></a>
    ...
    <nav class="navbar navbar-expand-lg  py-4" id="navbar">
        ...
        <div class="collapse navbar-collapse text-center" id="navbarsExample09">
            ...
            <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Về chúng tôi</a>
                    <ul class="dropdown-menu" aria-labelledby="dropdown03">
                        <li><a class="dropdown-item" href="about.html">Công ty chúng tôi</a></li>
            ...
            <a href="contact.html" class="btn btn-solid-border btn-round-full">Nhận báo giá</a>
            </form>
        </div>
        </div>
    </nav>
