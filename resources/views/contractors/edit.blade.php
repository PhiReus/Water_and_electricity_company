...
@section('content')
    <header class="page-title-bar">
        ...
        <h3 class="page-title">Sửa Nhà Thầu</h3>
    </header>

    <div class="page-section">
        <form method="post" action="{{ route('contractors.update', $contractor->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <input name="name" value="{{ old('name', $contractor->name) }}" type="text" class="form-control"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input name="email" value="{{ old('email', $contractor->email) }}" type="text" class="form-control"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <input name="phone" type="number" value="{{ old('phone', $contractor->phone) }}"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input name="address" type="text" value="{{ old('address', $contractor->address) }}"
