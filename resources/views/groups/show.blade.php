...
@section('content')
                                    ...
                                    <ul class="list-group">
                                        ...
                                        @foreach ($roles as $key => $role)
                                            ...
                                            <li class="list-group-item">
                                                <input type="checkbox" id="check-role" @checked(in_array($role->id, $active_roles)) name="roles[]"
    ...
    <script>
        ...
        var checkRole = document.querySelectorAll('.check-role');

        checkAll.addEventListener('click', function() {
            checkRole.forEach(function(el) {
                el.checked = checkAll.checked
            })
        })

        document.querySelectorAll('.checker').forEach(function (grName) {
            grName.onclick = function() {
                document.querySelectorAll('.' + grName.value).forEach(function(el) {
                    el.checked = grName.checked;
                }, grName);

                // var gr = document.querySelectorAll('.' + grName.value);
